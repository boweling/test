...
////////////////  获取验证码  ////////////////
       /*   () 的结果就是要返回的数据 */
Mock.mock('/captcha','get',() =>{     //模拟从后端返回验证码信息
        Result.data={
            token: Random.string(32),  /*  随机码  */
            captchaImg: Random.dataImage('120x40','p7n5w'),   /* 括号中，参数1：尺寸； 参数2： 文本内容*/
        }
        return Result;
})

////////////////  登录  ////////////////
Mock.mock('/login','post',() =>{   //模拟从后端返回登录的信息(restful数据)
    // 无法在header中传入数jwt
...
////////////////  获取用户信息  ////////////////
Mock.mock('/sys/userInfo','get',() =>{   //模拟从后端返回登录的信息(restful数据)
    Result.data={
        id: "1",
        username:"test",
        avatar:"https://img1.baidu.com/it/u=3755297117,609162545&fm=26&fmt=auto"
    }
    return Result;
})
...
Mock.mock('/sys/menu/nav', 'get', () => {
    ...
    let authoritys = ['sys:user:save','sys:user:delete']
...
Mock.mock(RegExp('/sys/role/list*'), 'get', () => {  /* 使用RegExp正则表达式，进行模糊匹配*/
